...
class MobileAuthorServiceTest {
    ...
    private MobileAuthorService service;

    private final Long userId = 1L;

    @BeforeEach
    void setUp() {
        service = new MobileAuthorService(authorRepository, authenticationService, fileService, entityManager);
    }
    ...
    class GetAuthorsTests {
        ...
        void getAuthors_admin_noFilters_returnsPage() {
            ...
            MobilePageResponse<MobileAuthorSummary> result = service.getAuthors(0, 30, "name", "asc", null, null, null);
        ...
        void getAuthors_admin_emptyResult_returnsEmptyPage() {
            ...
            MobilePageResponse<MobileAuthorSummary> result = service.getAuthors(0, 30, null, null, null, null, null);
        ...
        void getAuthors_nonAdmin_withAccessibleLibrary_succeeds() {
            ...
            MobilePageResponse<MobileAuthorSummary> result = service.getAuthors(0, 30, null, null, 5L, null, null);
        ...
        void getAuthors_withSearch_filtersResultsByName() {
            ...
            MobilePageResponse<MobileAuthorSummary> result = service.getAuthors(0, 30, null, null, null, "brandon", null);
        ...
        void getAuthors_withHasPhotoTrue_filtersToAuthorsWithPhotos() {
            ...
            MobilePageResponse<MobileAuthorSummary> result = service.getAuthors(0, 30, null, null, null, null, true);
        ...
        void getAuthors_withHasPhotoFalse_filtersToAuthorsWithoutPhotos() {
            ...
            MobilePageResponse<MobileAuthorSummary> result = service.getAuthors(0, 30, null, null, null, null, false);
        ...
        void getAuthors_paginationDefaults_appliedCorrectly() {
            ...
            MobilePageResponse<MobileAuthorSummary> result = service.getAuthors(null, null, null, null, null, null, null);
        ...
        void getAuthors_pageSizeCapped_atMax() {
            ...
            MobilePageResponse<MobileAuthorSummary> result = service.getAuthors(0, 100, null, null, null, null, null);
        ...
        void getAuthors_sortByBookCount_desc() {
            ...
            MobilePageResponse<MobileAuthorSummary> result = service.getAuthors(0, 30, "bookCount", "desc", null, null, null);
        ...
        void getAuthors_sortByRecent_desc() {
            ...
            MobilePageResponse<MobileAuthorSummary> result = service.getAuthors(0, 30, "recent", "desc", null, null, null);
    ...
    class GetAuthorDetailTests {
        ...
        void getAuthorDetail_admin_returnsDetail() {
            ...
            MobileAuthorDetail result = service.getAuthorDetail(1L);
        ...
        void getAuthorDetail_nonAdmin_withAccess_returnsDetail() {
            ...
            MobileAuthorDetail result = service.getAuthorDetail(2L);
